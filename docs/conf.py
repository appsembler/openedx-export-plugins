...
"""
openedx-export-plugins documentation build configuration file.
...
project = 'openedx-export-plugins'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'openedx-export-plugins'
...
#
# html_title = 'openedx-export-plugins v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Plugins to support Open edX course, library, block export',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_export_plugins'),
                os.path.join(root_path, 'openedx_export_plugins/migrations')])
